...
const translations = {
	ar: {
		...
		'input.additionalTests': 'اختبارات إضافية (يرجى القيام بها بالترتيب)',
		...
		'voice.good': 'جيد',
		'voice.complete': 'إكمال التحليل التالي',
		...
		// Total Result
		'totalResult.title': 'نتائج التحليل الكلي',
		'totalResult.patientInfo': 'معلومات المريض',
		'totalResult.name': 'الاسم',
		'totalResult.age': 'العمر',
		'totalResult.gender': 'الجنس',
		'totalResult.symptoms': 'الأعراض',
		'totalResult.medicalHistory': 'التاريخ المرضي',
		'totalResult.testResults': 'نتائج الفحوصات',
		'totalResult.testName': 'اسم الفحص',
		'totalResult.testResult': 'تفسير الفحص',
		'totalResult.confidence': 'نسبة الثقة',
		'totalResult.visionTest': 'الادراك البصري',
		'totalResult.speechTest': 'التحليل الصوتي',
		'totalResult.motionTest': 'تحليل الحركة',
		'totalResult.combinedResult': 'نسبة الاصابة بالتصلب المتعدد',
		'totalResult.combinedResultDescription': 'هذه هي النتيجة الكلية بالاعتماد على جميع الفحوصات',
		'totalResult.back': 'العودة للصفحة الرئيسية',
		'totalResult.newAnalysis': 'تحليل جديد',
		'totalResult.analysisReset': 'تم إعادة تعيين التحليل بنجاح، يتم إعادة التوجيه...',
		'totalResult.noResults': 'لا توجد نتائج متاحة للتحليل',
		'totalResult.pleaseCompleteTests': 'يرجى إكمال جميع الفحوصات لإظهار النتائج',
	},
	en: {
		// Hero Page
		'hero.title': 'NeuroSense',
		...
		'input.additionalTests': 'Additional Tests (please perform in order)',
		'input.voiceAnalysis': 'Voice Analysis',
		'input.imageAnalysis': 'Visual Analysis',
		...
		'input.reset': 'Reset Patient Data',
		...
		'voice.good': 'Good',
		'voice.complete': 'Complete Next Test',
		...
		'voice.recordingSaved': 'Voice recording saved, AI is analyzing your voice',
		...
		// Total Result
		'totalResult.title': 'Total Analysis Results',
		'totalResult.patientInfo': 'Patient Information',
		'totalResult.name': 'Name',
		'totalResult.age': 'Age',
		'totalResult.gender': 'Gender',
		'totalResult.symptoms': 'Symptoms',
		'totalResult.medicalHistory': 'Medical History',
		'totalResult.testResults': 'Test Results',
		'totalResult.testName': 'Test Name',
		'totalResult.testResult': 'Test Interpretation',
		'totalResult.confidence': 'Probability Confidence',
		'totalResult.visionTest': 'Visual Cognitive',
		'totalResult.speechTest': 'Voice Analysis',
		'totalResult.motionTest': 'Motion Disability',
		'totalResult.combinedResult': 'MS Probability',
		'totalResult.combinedResultDescription': 'This is the combined analysis result based on all tests.',
		'totalResult.back': 'Back To Home',
		'totalResult.newAnalysis': 'New Analysis',
		'totalResult.analysisReset': 'Analysis Reset Successfully, Redirecting...',
		'totalResult.noResults': 'No results available for analysis',
		'totalResult.pleaseCompleteTests': 'Please complete all tests to show results',
	},
};
