...
const translations = {
	ar: {
		...
		'hero.description':
			'رفيقك المتقدم للتحليل الطبي بالذكاء الاصطناعي. مدعوم بأحدث تقنيات الذكاء الاصطناعي والخبرة الطبية.',
		...
		'input.symptomsPlaceholder': 'أدخل الأعراض التي يعاني منها المريض',
		'input.gender': 'الجنس*',
		'input.genderPlaceholder': 'ادخل جنس المريض',
		'input.medicalHistory': 'التاريخ المرضي',
		'input.optional': '(إن وجد)',
		'input.medicalHistoryPlaceholder':
			'اكتب التاريخ المرضي للمريض (الأمراض السابقة، العمليات الجراحية، الأدوية المستمرة، الحساسية...)',
		...
		'voice.sampleQuoteAr':
			'أعاني من صداع وإرهاق منذ الأسبوع الماضي. الألم في معظمه في الصدغين ويزداد سوءًا في فترة ما بعد الظهر.',
		'voice.sampleQuoteEn':
			'I have been experiencing headaches and fatigue for the past week. The pain is mostly in my temples and gets worse in the afternoon.',
		...
		'voice.testCompleted': 'نتيجة التحليل',

		// Vision Test
		'vision.title': 'اختبار كفاءة الرؤية',
		'vision.question': 'هل الصورة واضحة لك؟',
		'vision.error': 'فشل تحميل الصورة او عرض النتائج',
		'vision.btnClear': 'واضحة',
		'vision.btnNonClear': 'غير واضحة',
		'vision.completed': 'لقد اكملت الاختبار',
		'vision.btnCompleted': 'الذهاب للتحليل التالي',

		// Disability Test
		'disability.title': 'اختبار قياس الإعاقة الحركية',
		'disability.subtitle': 'اختبار المشي',
		...
		'disability.instruction3': 'امش 2-6 متر بأسرع ما يمكنك بشكل آمن',
		'disability.instruction4': 'اضغط "إنهاء" عند الوصول لنهاية المسافة او عدم القدرة على المواصلة',
		...
		'disability.analyze': 'تحليل البيانات',
		'disability.reset': 'إعادة',
		'disability.viewResults': 'عرض النتائج',
		'disability.results': 'نتائج الاختبار',
		'disability.errorNoData': 'لا يوجد بيانات كافية',
		'disability.errorFail': 'خطأ في تحليل البيانات',
		'disability.timeTaken': 'الوقت المستغرق:',
		'disability.samplesLabel': 'عدد العينات:',
		'disability.sample': 'عينة',
		...
		'disability.analysisSuccess': 'تم الانتهاء من تحليل البيانات - برجاء اكمال باقي الاختبارات',
		'disability.nextTest': 'انتقل إلى الاختبار التالي',
		...
		'results.diagnosisText':
			'بناءً على الأعراض المذكورة والتاريخ المرضي، يوصى بإجراء فحوصات إضافية لتأكيد التشخيص.',
	...
	en: {
		...
		'hero.description':
			'Your advanced medical analysis companion powered by artificial intelligence. Backed by cutting-edge AI technology and medical expertise.',
		...
		'input.symptomsPlaceholder': 'Enter patient symptoms',
		'input.gender': 'Gender',
		'input.genderPlaceholder': 'Enter patient gender',
		'input.medicalHistory': 'Medical History',
		'input.optional': '(if available)',
		'input.medicalHistoryPlaceholder':
			'Enter patient medical history (previous diseases, surgeries, ongoing medications, allergies...)',
		...
		'voice.freeSpeakDesc':
			'Speak freely about your symptoms or anything you want. Your voice tone and emotions will be analyzed through your speech.',
		...
		'voice.testCompleted': 'Your Test Results',

		// Vision Test
		'vision.title': 'Visual Cognitive Test',
		'vision.question': 'Is the image below clear?',
		'vision.error': 'Failed to load image or get results',
		'vision.btnClear': 'Clear',
		'vision.btnNonClear': 'Not Clear',
		'vision.completed': 'You Completed The Test',
		'vision.btnCompleted': 'Go To Next Test',

		// Disability Test
		'disability.title': 'Mobility Disability Test',
		'disability.subtitle': 'Walk Test',
		...
		'disability.instruction3': 'Walk 2-6 meters as fast as safely possible',
		'disability.instruction4': 'Press "Finish" upon reaching the end or being too tired',
		...
		'disability.analyze': 'Analyze Data',
		'disability.reset': 'Reset',
		'disability.viewResults': 'View Results',
		'disability.results': 'Test Results',
		'disability.errorNoData': 'No Enough Samples',
		'disability.errorFail': 'Failed To Analyze Samples',
		'disability.timeTaken': 'Time Taken:',
		'disability.samplesLabel': 'Samples:',
		'disability.sample': 'point',
		...
		'disability.analysisSuccess': 'Data analysis completed - please proceed to complete other tests',
		'disability.nextTest': 'Proceed to Next Test',
		...
		'early.lowRisk':
			'The mentioned symptoms are not a strong indicator of the disease, but it is advised to follow up with a doctor if symptoms worsen.',
		...
		'results.diagnosisText':
			'Based on the mentioned symptoms and medical history, additional tests are recommended to confirm the diagnosis.',
