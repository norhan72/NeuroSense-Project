		...
		<div className='min-h-screen p-6 pb-24'>
			<div className='max-w-lg mx-auto space-y-6'>
				...
				<div className='text-center mb-8'>
					<h1 className='text-2xl font-orbitron font-bold text-foreground mb-2'>Voice AI Analysis</h1>
				...
				<GlassCard>
					<div>
						<h3 className='text-sm font-orbitron font-semibold text-foreground mb-3'>نوع التحليل الصوتي</h3>
				...
				<GlassCard>
					<div className='flex items-center justify-between'>
						<div>
							...
							<p className='text-xs text-foreground-secondary'>Choose your preferred language</p>
						</div>
						<Button
						...
						<div className='flex items-start space-x-3 space-x-reverse'>
							...
							<div>
								...
								<p className='text-sm text-foreground-secondary font-inter leading-relaxed'>
									تحدث بحرية عن أعراضك أو أي شيء تريد. سيتم تحليل نبرة صوتك ومشاعرك من خلال طريقة
									حديثك.
								</p>
							</div>
						</div>
				...
				<GlassCard glow>
					<div className='text-center'>
						...
						<div className='mb-4'>
							...
							{isRecording && (
								<p className='text-sm font-inter text-primary-light'>{formatTime(recordingTime)}</p>
							)}
						</div>
						...
						<div className='flex items-center justify-center space-x-1 h-16 mb-4'>
							{[...Array(20)].map((_, i) => (
								<div
									...
									style={{
										height: isRecording ? `${Math.max(4, (waveformData[i] || 0) / 2)}px` : '4px',
						...
						<p className='text-xs text-foreground-secondary font-inter'>
							{isRecording
								? voiceAnalysisMode === 'guided'
									? 'اقرأ النص المحدد أعلاه'
									: 'تحدث بحرية عن أعراضك'
				...
				<GlassCard>
					<div className='flex items-center justify-between'>
						<div>
							<h3 className='text-sm font-orbitron font-semibold text-foreground'>Voice Quality</h3>
							<p className='text-xs text-foreground-secondary'>AI analysis accuracy</p>
						</div>
								...
								{[...Array(5)].map((_, i) => (
									<div
										...
										className={`w-2 h-4 rounded-sm ${
											i < (isRecording ? 4 : 2) ? 'bg-medical-green' : 'bg-glass-border'
										}`}
									/>
								))}
							</div>
