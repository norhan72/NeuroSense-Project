	...
	return (
		<div className='min-h-screen flex flex-col items-center justify-center relative overflow-hidden'>
			...
			<div className='absolute inset-0 opacity-10'>
				...
				<div
					className='absolute bottom-20 left-20 w-48 h-48 border-2 border-secondary rounded-full animate-dna'
			...
			<div className='relative z-10 text-center max-w-4xl px-6'>
				...
				<div className='bg-card/50 backdrop-blur-lg rounded-2xl p-8 md:p-12 border border-border/50 animate-pulse-glow'>
					...
					<p className='text-lg text-muted-foreground mb-6 max-w-2xl mx-auto'>{t('hero.description')}</p>
				...
				{/* Version Info */}
				<div className='mt-8 text-sm text-muted-foreground'>{t('hero.version')}</div>
			</div>
		</div>
	);
}
